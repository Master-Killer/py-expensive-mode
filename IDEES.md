...
| ~~Chaîne sur les science packs eux-mêmes (le pack N contient des packs N−1)~~ | **Rejeté** : un pack ne doit pas consommer un autre pack. Remplacé par l'extension de la famille `earth-*-sample` (pyalienlife, bâtiment data-array) : chaque recette y consomme déjà exactement UN science pack pour fabriquer l'échantillon d'une espèce ; 5 packs (py1, military, production, utility, space) n'y apparaissent dans aucune des 26 recettes existantes — voir doc 10. | S | Haute |
